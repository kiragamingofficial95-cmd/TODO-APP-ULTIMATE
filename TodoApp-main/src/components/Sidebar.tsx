  ...
  return (
    <Container>
      ...
      >
        ...
        <MenuLink to="https://github.com/kiragamingofficial95-cmd/TODO-APP-ULTIMATE">
        ...
        <MenuLink to="https://github.com/kiragamingofficial95-cmd/TODO-APP-ULTIMATE/issues/new">
          <StyledMenuItem>
        ...
        <MenuLink to="https://www.google.com">
        ...
        <ProfileOptionsBottom>
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/kiragamingofficial95-cmd/"
            >
              Varad agarwal
            </a>
          </CreditsContainer>
