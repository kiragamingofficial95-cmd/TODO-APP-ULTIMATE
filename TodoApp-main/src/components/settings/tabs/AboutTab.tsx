  ...
  return (
    <>
      ...
      <Typography variant="caption" sx={{ display: "block", mt: 2 }}>
        Created by <Link href="https://github.com/kiragamingofficial95-cmd">varad agarwal(kira)</Link> <br />
        Explore the project on GitHub:{" "}
        <Link href="https://github.com/kiragamingofficial95-cmd/TODO-APP-ULTIMATE.git" target="_blank" rel="noopener noreferrer">
          Todo App Repository
        </Link>
      </Typography>
